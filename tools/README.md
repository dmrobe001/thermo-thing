...
`scene-roundtrip.js`, `rack-check.js`, `multipoint-check.js`, `posable-check.js`, `select-check.js`, `frame-check.js` and `expr-check.js` are the exceptions to the "do not import the simulator" rule
